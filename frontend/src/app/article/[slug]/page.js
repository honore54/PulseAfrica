      ...
      <article style={{ maxWidth:780, margin:'0 auto', padding:'48px 40px 80px', position:'relative', zIndex:10 }}>
        ...
        <div style={{ marginTop:40, paddingTop:24, borderTop:'1px solid var(--lace)' }}>
          ...
          <p style={{ fontSize:13, color:'var(--ink6)', lineHeight:1.8 }}>
            This article was researched and compiled by the PulseAfrica editorial team using information from international news sources including{' '}
            ...
            PulseAfrica is committed to accurate, balanced and independent journalism covering all 54 African nations in three languages.
          </p>
        </div>
