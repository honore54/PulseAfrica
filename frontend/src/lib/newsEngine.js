...
{"title_en":"keyword-first headline max 75 chars","title_fr":"titre français max 75 chars","title_rw":"umutwe kinyarwanda max 75 chars","summary_en":"2 punchy sentences max 180 chars. Sentence 1: the key fact. Sentence 2: why it matters for Africa specifically. No filler words.","summary_fr":"2 phrases accrocheuses max 180 chars","summary_rw":"interuro 2 max 180 inyuguti","content_en":"750-900 words. ## Opening: most important fact first (inverted pyramid). ## What Happened: specific names, places, dates from source. ## African Context and Impact: why this matters for Africa, link to broader continental trends. ## Expert Perspective: implications, patterns, what analysts would say. ## What This Means For Readers: practical impact on citizens, businesses, governments. ## Looking Ahead: what to watch next. Write like BBC Africa senior journalist. Every sentence must add unique value. No filler. No phrases like: significant development, it is worth noting, in conclusion, furthermore.","content_fr":"550-650 mots. ## 5 sous-titres. Meme structure que EN. Style BBC Afrique.","content_rw":"400-500 amagambo. ## inshuti 5. Inzira imwe na EN. Ubu buhanga bwa BBC.","tags":["keyword","country","topic","category","africa"],"read_time":4,"location":"City, Country","image_query":"5-7 word SPECIFIC Unsplash photo query matching the exact article topic — e.g. Kenya parliament building, Burna Boy concert stage, Lagos stock exchange, African football stadium. Must be vivid and specific NOT generic.","focus_keyword":"the single most important SEO keyword for this article (1-3 words max)","secondary_keywords":["3 more keywords people search on Google related to this article"],"seo_title":"55-60 chars EXACTLY. Primary keyword first. Written to rank on Google and compel clicks.","seo_desc":"150-155 chars EXACTLY. Compelling meta description with primary keyword and a hook that makes people click."}`
}
...
export async function generateArticle(category, maxRetries = 2) {
  ...
  for (let attempt = 1; attempt <= maxRetries; attempt++) {
    try {
      ...
      if (parsed.content_en.length < 1800) {
